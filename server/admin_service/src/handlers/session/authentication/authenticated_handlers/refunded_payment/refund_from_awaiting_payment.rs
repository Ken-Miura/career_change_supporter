...
pub(crate) struct RefundFromAwaitingPaymentResult {}

async fn handle_refund_from_awaiting_payment(
    consultation_id: i64,
        ...
        self.pool
            ...
            .map_err(|e| match e {
                ...
                TransactionError::Transaction(err_resp_struct) => {
                    error!(
                        "failed to refund_from_awaiting_payment: {}",
                        err_resp_struct
                    );
...
mod tests {
    ...
    #[tokio::test]
    async fn test_handle_refund_from_awaiting_payment_success() {
        ...
        assert_eq!(RefundFromAwaitingPaymentResult {}, resp.1 .0);
    }

    #[tokio::test]
    async fn test_handle_refund_from_awaiting_payment_fail_non_positive_consultation_id() {
    ...
    #[tokio::test]
    async fn test_handle_refund_from_awaiting_payment_fail_invalid_email_address() {
        let consultation_id = 512;
        let admin_email_address = "abc".to_string();
        let current_date_time = JAPANESE_TIME_ZONE
            .with_ymd_and_hms(2023, 9, 5, 21, 0, 40)
