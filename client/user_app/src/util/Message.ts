...
export namespace Message {
    ...
    export const SKY_WAY_AUDIO_MEETING_ROOM_HAS_ALREADY_BEEN_INITILIZED = '相談の開始に失敗しました。一度ブラウザを閉じて再度相談を開始して下さい。問題が解決しない場合、別の端末、OS、またはブラウザでお試し下さい: SKY_WAY_AUDIO_MEETING_ROOM_HAS_ALREADY_BEEN_INITILIZED'
    export const SKY_WAY_AUDIO_MEETING_ROOM_HAS_NOT_BEEN_INITILIZED_YET = '相談の開始に失敗しました。一度ブラウザを閉じて再度相談を開始して下さい。問題が解決しない場合、別の端末、OS、またはブラウザでお試し下さい: SKY_WAY_AUDIO_MEETING_ROOM_HAS_NOT_BEEN_INITILIZED_YET'
