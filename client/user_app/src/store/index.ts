...
import { SET_PASSWORD_UPDATE_RESULT_MESSAGE, SET_BANK_ACCOUNT, SET_FEE_PER_HOUR_IN_YEN, SET_IDENTITY, SET_CONSULTANT_SEARCH_PARAM, SET_RECOVERY_CODE } from './mutationTypes'
