...
export namespace Code {
  ...
  export const PAYMENT_IS_NOT_DONE_YET = 20145
}
...
codeToMessage.set(Code.PAYMENT_IS_NOT_DONE_YET.toString(), `${Message.PAYMENT_IS_NOT_DONE_YET_MESSAGE} (${Code.PAYMENT_IS_NOT_DONE_YET})`)
