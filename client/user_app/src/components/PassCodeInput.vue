<template>
  <div class="pt-3 rounded bg-gray-200">
    ...
    <input v-on:input="onInput" type="text" inputmode="numeric" pattern="[0-9]{6}" title="半角数字のみの6桁でご入力下さい。" required minlength="6" maxlength="6" class="text-right bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
  </div>
</template>
