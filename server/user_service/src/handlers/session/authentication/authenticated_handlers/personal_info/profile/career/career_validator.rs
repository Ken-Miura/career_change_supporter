...
fn validate_company_name(company_name: &str) -> Result<(), CareerValidationError> {
    crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::validate_company_name(company_name).map_err(|e| match e {
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::CompanyNameValidationError::InvalidCompanyNameLength {
            length,
            min_length,
            max_length,
        ...
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::CompanyNameValidationError::IllegalCharInCompanyName(
            company_name,
...
fn validate_department_name(department_name: &str) -> Result<(), CareerValidationError> {
    crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::validate_department_name(department_name).map_err(|e| match e {
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::DepartmentNameValidationError::InvalidDepartmentNameLength {
            length,
            min_length,
            max_length,
        ...
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::DepartmentNameValidationError::IllegalCharInDepartmentName(
            department_name,
...
fn validate_office(office: &str) -> Result<(), CareerValidationError> {
    crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::validate_office(office).map_err(|e| match e {
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::OfficeValidationError::InvalidOfficeLength {
            length,
            min_length,
            max_length,
        ...
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::OfficeValidationError::IllegalCharInOffice(office) => {
...
fn validate_contract_type(contract_type: &str) -> Result<(), CareerValidationError> {
    crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::validate_contract_type(contract_type).map_err(|e| match e {
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::ContractTypeValidationError::IllegalContractType(contract_type) => {
...
fn validate_profession(profession: &str) -> Result<(), CareerValidationError> {
    crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::validate_profession(profession).map_err(|e| match e {
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::ProfessionValidationError::InvalidProfessionLength {
            length,
            min_length,
            max_length,
        ...
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::ProfessionValidationError::IllegalCharInProfession(profession) => {
...
fn validate_annual_income_in_man_yen(
    ...
    crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::validate_annual_income_in_man_yen(annual_income_in_man_yen).map_err(|e| match e {
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::AnnualIncomInManYenValidationError::IllegalAnnualIncomeInManYen(annual_income_in_man_yen) => CareerValidationError::IllegalAnnualIncomeInManYen(annual_income_in_man_yen),
    })?;
    Ok(())
}

fn validate_position_name(position_name: &str) -> Result<(), CareerValidationError> {
    crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::validate_position_name(position_name).map_err(|e| match e {
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::PositionNameValidationError::InvalidPositionNameLength {
            length,
            min_length,
            max_length,
        ...
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::PositionNameValidationError::IllegalCharInPositionName(
            position_name,
...
fn validate_note(note: &str) -> Result<(), CareerValidationError> {
    crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::validate_note(note).map_err(|e| match e {
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::NoteValidationError::InvalidNoteLength {
            length,
            min_length,
            max_length,
        ...
        crate::handlers::session::authentication::authenticated_handlers::personal_info::profile::career::NoteValidationError::IllegalCharInNote(note) => {
