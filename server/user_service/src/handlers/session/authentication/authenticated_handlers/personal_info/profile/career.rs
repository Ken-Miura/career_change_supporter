...
pub(in crate::handlers::session::authentication::authenticated_handlers) const COMPANY_NAME_MIN_LENGTH: usize = 1;
pub(in crate::handlers::session::authentication::authenticated_handlers) const COMPANY_NAME_MAX_LENGTH: usize = 256;
pub(in crate::handlers::session::authentication::authenticated_handlers) const DEPARTMENT_NAME_MIN_LENGTH: usize = 1;
pub(in crate::handlers::session::authentication::authenticated_handlers) const DEPARTMENT_NAME_MAX_LENGTH: usize = 256;
pub(in crate::handlers::session::authentication::authenticated_handlers) const OFFICE_MIN_LENGTH:
    usize = 1;
pub(in crate::handlers::session::authentication::authenticated_handlers) const OFFICE_MAX_LENGTH:
    usize = 256;
pub(in crate::handlers::session::authentication::authenticated_handlers) const PROFESSION_MIN_LENGTH: usize = 1;
pub(in crate::handlers::session::authentication::authenticated_handlers) const PROFESSION_MAX_LENGTH: usize = 128;
pub(in crate::handlers::session::authentication::authenticated_handlers) const POSITION_NAME_MIN_LENGTH: usize = 1;
pub(in crate::handlers::session::authentication::authenticated_handlers) const POSITION_NAME_MAX_LENGTH: usize = 128;
pub(in crate::handlers::session::authentication::authenticated_handlers) const NOTE_MIN_LENGTH:
    usize = 1;
pub(in crate::handlers::session::authentication::authenticated_handlers) const NOTE_MAX_LENGTH:
    usize = 2048;

/// 99999万円（9億9999万円）が最大値
pub(in crate::handlers::session::authentication::authenticated_handlers) const MAX_ANNUAL_INCOME_IN_MAN_YEN: i32 = 99999;
...
pub(in crate::handlers::session::authentication::authenticated_handlers) fn validate_company_name(
    company_name: &str,
...
pub(in crate::handlers::session::authentication::authenticated_handlers) enum CompanyNameValidationError
{
...
pub(in crate::handlers::session::authentication::authenticated_handlers) fn validate_department_name(
    department_name: &str,
...
#[derive(Debug, PartialEq)]
pub(in crate::handlers::session::authentication::authenticated_handlers) enum DepartmentNameValidationError
{
...
pub(in crate::handlers::session::authentication::authenticated_handlers) fn validate_office(
    office: &str,
...
#[derive(Debug, PartialEq)]
pub(in crate::handlers::session::authentication::authenticated_handlers) enum OfficeValidationError
{
    InvalidOfficeLength {
        length: usize,
        min_length: usize,
...
pub(in crate::handlers::session::authentication::authenticated_handlers) fn validate_contract_type(
    contract_type: &str,
...
#[derive(Debug, PartialEq)]
pub(in crate::handlers::session::authentication::authenticated_handlers) enum ContractTypeValidationError
{
    IllegalContractType(String),
}

pub(in crate::handlers::session::authentication::authenticated_handlers) fn validate_profession(
    profession: &str,
...
#[derive(Debug, PartialEq)]
pub(in crate::handlers::session::authentication::authenticated_handlers) enum ProfessionValidationError
{
...
pub(in crate::handlers::session::authentication::authenticated_handlers) fn validate_annual_income_in_man_yen(
...
#[derive(Debug, PartialEq)]
pub(in crate::handlers::session::authentication::authenticated_handlers) enum AnnualIncomInManYenValidationError
{
    IllegalAnnualIncomeInManYen(i32),
}

pub(in crate::handlers::session::authentication::authenticated_handlers) fn validate_position_name(
    position_name: &str,
...
#[derive(Debug, PartialEq)]
pub(in crate::handlers::session::authentication::authenticated_handlers) enum PositionNameValidationError
{
...
pub(in crate::handlers::session::authentication::authenticated_handlers) fn validate_note(
    note: &str,
...
#[derive(Debug, PartialEq)]
pub(in crate::handlers::session::authentication::authenticated_handlers) enum NoteValidationError {
    InvalidNoteLength {
        length: usize,
        min_length: usize,
        max_length: usize,
