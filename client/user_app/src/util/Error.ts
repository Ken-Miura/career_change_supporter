...
export namespace Code {
  ...
  export const NO_ENOUGH_SPARE_TIME_BEFORE_MEETING = 20143
  export const CONSULTATION_HAS_NOT_BEEN_FINISHED = 20144
}
...
codeToMessage.set(Code.NO_ENOUGH_SPARE_TIME_BEFORE_MEETING.toString(), `${Message.NO_ENOUGH_SPARE_TIME_BEFORE_MEETING_MESSAGE} (${Code.NO_ENOUGH_SPARE_TIME_BEFORE_MEETING})`)
codeToMessage.set(Code.CONSULTATION_HAS_NOT_BEEN_FINISHED.toString(), `${Message.CONSULTATION_HAS_NOT_BEEN_FINISHED_MESSAGE} (${Code.CONSULTATION_HAS_NOT_BEEN_FINISHED})`)
