      ...
      <section class="mt-6">
        <form class="flex flex-col" @submit.prevent="passCodeHandler">
          ...
          <div class="flex justify-end">
            <router-link to="/password-change-req" class="text-sm text-gray-600 hover:text-gray-700 hover:underline mb-6">リカバリーコードを用いたログイン</router-link>
          </div>
...
import { usePostPassCode } from '@/util/personalized/mfa/usePostPassCode'
import { PostPassCodeResp } from '@/util/personalized/mfa/PostPassCodeResp'
