...
use common::{
    ...
    util::check_env_vars,
    JAPANESE_TIME_ZONE, KEY_TO_USE_ECS_TASK_ROLE, LENGTH_OF_MEETING_IN_MINUTE, USE_ECS_TASK_ROLE,
    WEB_SITE_NAME,
};
...
mod tests {
    ...
    async fn make_payment_of_unhandled_settlement_success0() {
        ...
        let num_handled = result.expect("failed to get Ok");
        assert_eq!(num_handled, 0);
    }
    ...
    async fn make_payment_of_unhandled_settlement_success5() {
        ...
        let max_num_of_target_records = 0;
        let op = MakePaymentOfUnhandledSettlementOperationMock {
            settlements: create_dummy_2_unhandled_settlements(current_date_time),
            current_date_time,
            limit: max_num_of_target_records,
        };
        // 成功時はメールを送らないので、わざと失敗するような内容でモックを生成する
        ...
        let num_handled = result.expect("failed to get Ok");
        assert_eq!(num_handled, 2);
    }

    fn create_dummy_2_unhandled_settlements(
        current_date_time: DateTime<FixedOffset>,
    ) -> HashMap<i64, (Settlement, DateTime<FixedOffset>, bool)> {
        ...
        map.insert(settlement_id1, (settlement1, meeting_at1, true));
        map.insert(settlement_id2, (settlement2, meeting_at2, true));
        map
    }
    ...
    async fn make_payment_of_unhandled_settlement_success9() {
        ...
        let max_num_of_target_records = 0;
        let op = MakePaymentOfUnhandledSettlementOperationMock {
            settlements: create_dummy_1_settlement_and_1_unhandled_settlement(current_date_time),
            current_date_time,
            limit: max_num_of_target_records,
        };
        // 成功時はメールを送らないので、わざと失敗するような内容でモックを生成する
    ...
    fn create_dummy_1_settlement_and_1_unhandled_settlement(
        current_date_time: DateTime<FixedOffset>,
    ) -> HashMap<i64, (Settlement, DateTime<FixedOffset>, bool)> {
        let settlement_id1 = 1234;
        let settlement1 = Settlement {
    ...
    async fn make_payment_of_unhandled_settlement_fail1() {
        ...
        let max_num_of_target_records = 0;
        let op = MakePaymentOfUnhandledSettlementOperationMock {
            settlements: create_dummy_1_failed_unhandled_settlement(current_date_time),
            current_date_time,
            limit: max_num_of_target_records,
        };
        let send_mail_mock = SendMailMock::new(
            ...
            vec![
                "処理されていないsettlementレコード1個の内、1個の処理に失敗しました。".to_string(),
                "1234".to_string(),
                "45".to_string(),
    ...
    fn create_dummy_1_failed_unhandled_settlement(
        ...
        let mut map = HashMap::with_capacity(1);
        map.insert(settlement_id, (settlement, meeting_at, false));
        map
    }
    ...
    async fn make_payment_of_unhandled_settlement_fail3() {
        ...
        let max_num_of_target_records = 0;
        let op = MakePaymentOfUnhandledSettlementOperationMock {
            settlements: create_dummy_1_failed_unhandled_settlement_and_1_unhandled_settlement(
                current_date_time,
            ),
            current_date_time,
            limit: max_num_of_target_records,
        ...
        let send_mail_mock = SendMailMock::new(
            ...
            vec![
                "処理されていないsettlementレコード2個の内、1個の処理に失敗しました。".to_string(),
                "456".to_string(),
                "78".to_string(),
                "ch_ea990a4c10672a93053a774730b0b".to_string(),
                "10000".to_string(),
    ...
    fn create_dummy_1_failed_unhandled_settlement_and_1_unhandled_settlement(
        current_date_time: DateTime<FixedOffset>,
    ) -> HashMap<i64, (Settlement, DateTime<FixedOffset>, bool)> {
        let settlement_id1 = 1234;
        let settlement1 = Settlement {
