  ...
  <div class="bg-gradient-to-r from-gray-500 to-gray-900 bo min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main class="flex flex-col justify-center bg-white max-w-3xl mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
      <div>
        ...
        <p class="mt-2">この利用規約（以下，「本規約」といいます。）は，＿＿＿＿＿（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。</p>
        <div class="mt-4">
          <h2 class="font-bold text-xl">第1条（適用）</h2>
        ...
        <div class="mt-4">
          <h2 class="font-bold text-xl">第2条（利用登録）</h2>
          <ol class="list-decimal ml-6">
            <li>本サービスにおいては，登録希望者が本規約に同意の上，当社の定める方法によって利用登録を申請し，当社がこの承認を登録希望者に通知することによって，利用登録が完了するものとします。</li>
            <li>当社は，利用登録の申請者に以下の事由があると判断した場合，利用登録の申請を承認しないことがあり，その理由については一切の開示義務を負わないものとします。
            <ol class="list-decimal ml-6"><li>利用登録の申請に際して虚偽の事項を届け出た場合</li><li>本規約に違反したことがある者からの申請である場合</li><li>その他，当社が利用登録を相当でないと判断した場合</li></ol></li>
          </ol>
        </div>
        <div class="mt-4">
          <h2 class="font-bold text-xl">第3条（ユーザーIDおよびパスワードの管理）</h2>
          <ol class="list-decimal ml-6">
        ...
        <div class="mt-4">
          <h2 class="font-bold text-xl">第4条（利用料金および支払方法）</h2>
          <ol class="list-decimal ml-6">
        ...
        <div class="mt-4">
          <h2 class="font-bold text-xl">第6条（本サービスの提供の停止等）</h2>
          <ol class="list-decimal ml-6">
        ...
        <div class="mt-4">
          <h2 class="font-bold text-xl">第7条（著作権）</h2>
          <ol class="list-decimal ml-6">
