  ...
  <div class="bg-gradient-to-r from-gray-500 to-gray-900 min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main v-else>
      <div class="flex flex-col justify-center bg-white max-w-4xl mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        ...
        <p class="mt-2 text-lg">相談受け付けを行うために必要となる情報です。職務経歴の確認を依頼後、入力した値が反映された時点で、職務経歴の登録が完了となります。<span class=" text-red-500">相談申し込みの判断に使われるため、他のユーザーに公開されます。</span>入社日と退社日は在籍年数（3年未満、3年以上5年未満、5年以上10年未満、10年以上15年未満、15年以上20年未満、20年以上）という形に変換され、そのまま公開されることはありません。退社日が入力されていない場合、在籍年数は入社日と職務経歴の登録が完了した日付から算出されます。</p>
        <form @submit.prevent="submitCareer">
          <div class="m-4 text-2xl grid grid-cols-6">
            ...
            <div data-test="career-end-day-label" class="mt-2 text-2xl justify-self-start col-span-1 pt-3 pl-3">日</div>
            ...
            <div data-test="career-image2-label" class="mt-6 pl-3 w-full justify-self-start col-span-1">
              裏面
            </div>
            <div class="mt-2 w-full justify-self-start col-span-5 pt-3 rounded bg-gray-200">
