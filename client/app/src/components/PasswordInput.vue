<template>
  <div class="pt-3 rounded bg-gray-200">
    ...
    <input v-on:input="onInput" type="password" required pattern="[!-~]{10,32}" title="英大文字、英小文字、数字、記号の内、2種類以上を組み合わせた10文字以上32文字以下の文字列" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
  </div>
</template>
