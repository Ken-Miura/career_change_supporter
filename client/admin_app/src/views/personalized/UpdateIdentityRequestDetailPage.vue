<template>
  ...
  <div class="bg-gradient-to-r from-gray-500 to-gray-900 min-h-screen pt-12 lg:pt-20 pb-6 px-2 lg:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main v-else>
      ...
      <div v-else>
        <div data-test="req-detail" class="flex flex-col justify-center bg-white max-w-6xl mx-auto p-8 lg:p-12 my-10 rounded-lg shadow-2xl">
        ...
        <div class="flex flex-row justify-center bg-white max-w-6xl mx-auto p-8 lg:p-12 my-10 rounded-lg shadow-2xl">
