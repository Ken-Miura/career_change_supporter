    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <p class="leading-normal text-xl mb-8">
            働いてみて初めてわかる問題は、実際に働いている方（働いたことのある方）に相談することで解決に近づきます。そのため、このサイトでは、就職先、転職先について確認がしたいユーザーと、そのユーザーが確認したい就職先、転職先で働いている（働いたことがある）ユーザーをマッチングさせ、相談の場を提供することで問題の解決をサポートします。ユーザー同士のやり取りは匿名（※）で行うことができ、相談の際はお互いの声を加工した状態で話し合っていただきます。
          </p>
          <p class="leading-normal text-xl mb-8">
            （※）相談をしたいユーザーの相談申し込みの判断に利用されるため、相談を受けるユーザーの職務経歴は公開されます。
          </p>
        </div>
        <!--Right Col-->
