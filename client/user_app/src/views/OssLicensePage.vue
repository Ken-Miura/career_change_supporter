  ...
  <div class="bg-gradient-to-r from-gray-500 to-gray-900 min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main class="bg-white max-w-3xl mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
      ...
      <div class="mt-4">
        ...
        <p class="ml-4">Released under the MIT license</p>
        <p class="ml-6">https://github.com/tailwindlabs/tailwindcss/blob/master/LICENSE</p>
      </div>
      <div class="mt-4">
        ...
        <p class="ml-4">Released under the MIT license</p>
        <p class="ml-6">https://github.com/vuejs/core/blob/main/LICENSE</p>
      </div>
      <div class="mt-4">
        ...
        <p class="ml-4">Released under the MIT license</p>
        <p class="ml-6">https://github.com/vuejs/router/blob/main/LICENSE</p>
      </div>
      <div class="mt-4">
        ...
        <p class="ml-4">Released under the MIT license</p>
        <p class="ml-6">https://github.com/vuejs/vuex/blob/main/LICENSE</p>
      </div>
      <div class="mt-4">
        ...
        <p class="ml-4">Released under the MIT license</p>
        <p class="ml-6">https://github.com/tserkov/vue-plugin-load-script/blob/master/LICENSE.md</p>
      </div>
    </main>
