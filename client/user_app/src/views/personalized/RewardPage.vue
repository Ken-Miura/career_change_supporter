                ...
                <div class="mt-4">
                  ...
                  <div v-else-if="transfer.status === 'paid'">
                    <div class="border border-t-0 border-gray-600 rounded-b bg-white px-4 py-3 text-black text-base lg:text-xl grid grid-cols-2">
                      ...
                      <div v-if="transfer.transfer_amount === null" class="justify-self-start col-span-1">入金額</div><div v-if="transfer.transfer_amount === null" class="justify-self-start col-span-1">入金額が正しく表示出来ませんでした。お手数ですが、<router-link class="font-bold" to="/transaction-law">お問い合わせ先</router-link>より問題のご報告をお願いいたします。</div>
                      ...
                      <div v-if="transfer.transfer_date_in_jst === null" class="justify-self-start col-span-1">入金日</div><div v-if="transfer.transfer_date_in_jst === null" class="justify-self-start col-span-1">入金日が正しく表示出来ませんでした。お手数ですが、<router-link class="font-bold" to="/transaction-law">お問い合わせ先</router-link>より問題のご報告をお願いいたします。</div>
                    </div>
                  </div>
