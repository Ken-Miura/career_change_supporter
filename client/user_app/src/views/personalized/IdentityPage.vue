  ...
  <div class="bg-gradient-to-r from-gray-500 to-gray-900 min-h-screen pt-12 lg:pt-20 pb-6 px-2 lg:px-0" style="font-family:'Lato',sans-serif;">
    ...
    <main v-else>
      <div class="flex flex-col justify-center bg-white max-w-4xl mx-auto p-8 lg:p-12 my-10 rounded-lg shadow-2xl">
        ...
        <p class="mt-2 text-base lg:text-xl">本人確認のために利用される情報です（本人確認の完了後、相談申し込みが可能となります）本人確認の依頼後、入力した値がユーザー情報に反映された時点で、本人確認が完了となります。ユーザー情報が他のユーザーに公開されることはありません。</p>
        <form @submit.prevent="submitIdentity">
          <div class="m-4 text-2xl grid grid-cols-6">
            <div class="mt-2 text-xl lg:text-2xl justify-self-start col-span-6 pt-3">
              氏名
            </div>
            <div data-test="last-name-div" class="mt-2 justify-self-start col-span-3 pt-3 rounded bg-gray-200">
              ...
              <input v-bind:value="form.lastName" v-on:input="setLastName" type="text" required minlength="1" maxlength="64" class="text-xl lg:text-2xl bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
            </div>
            <div data-test="first-name-div" class="mt-2 ml-1 justify-self-start col-span-3 pt-3 rounded bg-gray-200">
              ...
              <input v-bind:value="form.firstName" v-on:input="setFirstName" type="text" required minlength="1" maxlength="64" class="text-xl lg:text-2xl bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
            </div>
            <div class="mt-2 text-xl lg:text-2xl justify-self-start col-span-6 pt-3">
              フリガナ
            </div>
            <div data-test="last-name-furigana-div" class="mt-2 justify-self-start col-span-3 pt-3 rounded bg-gray-200">
              ...
              <input v-bind:value="form.lastNameFurigana" v-on:input="setLastNameFurigana" type="text" required minlength="1" maxlength="64" class="text-xl lg:text-2xl bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
            </div>
            <div data-test="first-name-furigana-div" class="mt-2 ml-1 justify-self-start col-span-3 pt-3 rounded bg-gray-200">
              ...
              <input v-bind:value="form.firstNameFurigana" v-on:input="setFirstNameFurigana" type="text" required minlength="1" maxlength="64" class="text-xl lg:text-2xl bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
            </div>
            <div class="mt-4 text-xl lg:text-2xl justify-self-start col-span-6 pt-3">
              生年月日
            </div>
            <div data-test="year-select-div" class="mt-2 w-full text-xl lg:text-2xl justify-self-start col-span-5">
            ...
            <div data-test="year-div" class="mt-2 text-xl lg:text-2xl justify-self-start col-span-1 pt-3 pl-3">
              年
            </div>
            <div data-test="month-select-div" class="mt-2 w-full text-xl lg:text-2xl justify-self-start col-span-5">
            ...
            <div data-test="month-div" class="mt-2 text-xl lg:text-2xl justify-self-start col-span-1 pt-3 pl-3">
              月
            </div>
            <div data-test="day-select-div" class="mt-2 w-full text-xl lg:text-2xl justify-self-start col-span-5">
            ...
            <div data-test="day-div" class="mt-2 text-xl lg:text-2xl justify-self-start col-span-1 pt-3 pl-3">
              日
            </div>
            <div class="mt-4 text-xl lg:text-2xl justify-self-start col-span-6 pt-3">
              住所
            </div>
            <div data-test="prefecture-select-div" class="mt-2 w-full text-xl lg:text-2xl justify-self-start col-span-6">
            ...
            <div data-test="city-div" class="mt-2 w-full justify-self-start col-span-6 pt-3 pl-2 rounded bg-gray-200">
              ...
              <input v-bind:value="form.city" v-on:input="setCity" type="text" required minlength="1" maxlength="32" class="text-xl lg:text-2xl bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
            </div>
            <div data-test="address-line1-div" class="mt-2 w-full justify-self-start col-span-6 pt-3 pl-2 rounded bg-gray-200">
              ...
              <input v-bind:value="form.addressLine1" v-on:input="setAddressLine1" type="text" required minlength="1" maxlength="128" class="text-xl lg:text-2xl bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
            </div>
            <div data-test="address-line2-div" class="mt-2 w-full justify-self-start col-span-6 pt-3 pl-2 rounded bg-gray-200">
              ...
              <input v-bind:value="form.addressLine2" v-on:input="setAddressLine2" type="text" minlength="0" maxlength="128" class="text-xl lg:text-2xl bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
            </div>
            <div data-test="tel-div" class="mt-4 text-xl lg:text-2xl justify-self-start col-span-6 pt-3">
            ...
            <div data-test="tel-input-div" class="mt-2 w-full justify-self-start col-span-6 pt-3 pl-2 rounded bg-gray-200">
              <input v-bind:value="form.telephoneNumber" v-on:input="setTelephoneNumber" type="text" inputmode="tel" pattern="[0-9]{10,13}" title="半角数字のみで10桁以上13桁以下でご入力下さい。" required minlength="10" maxlength="13" class="text-xl lg:text-2xl bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
            </div>
            <div data-test="identity-image-div" class="mt-4 text-xl lg:text-2xl justify-self-start col-span-6 pt-3">
              身分証明書
            </div>
            <div class="mt-2 text-base lg:text-xl justify-self-start col-span-6 pt-3 pl-3">
              身分証明書の画像は<span class=" text-red-500">jpegで、サイズが8MB以下</span>である必要が有ります。<span class=" text-red-500">運転免許証またはマイナンバーカード</span>を身分証明書としてご利用可能です。運転免許証は表面と裏面、<span class=" text-red-500">マイナンバーカードは表面（顔写真記載面）のみ</span>をアップロードしてください（いずれも<span class=" text-red-500">有効期限内</span>のものをアップロードください）
            </div>
            <div class="mt-2 w-full justify-self-start col-span-6 pt-2 rounded bg-gray-200">
              <label data-test="identity-image1-div" class="block text-gray-700 text-base lg:text-2xl font-bold mb-2 ml-3">表面</label>
            ...
            <div class="mt-2 w-full justify-self-start col-span-6 pt-3 rounded bg-gray-200">
              <label data-test="identity-image2-div" class="block text-gray-700 text-base lg:text-2xl font-bold mb-2 ml-3">裏面</label>
