...
export namespace Code {
  ...
  export const CONSULTANT_IS_NOT_AVAILABLE_ON_CONSULTATION_ACCEPTANCE = 20118
  export const USER_IS_NOT_AVAILABLE_ON_CONSULTATION_ACCEPTANCE = 20119
  export const USER_HAS_SAME_MEETING_DATE_TIME = 20120
  export const CONSULTANT_HAS_SAME_MEETING_DATE_TIME = 20121
  export const MEETING_DATE_TIME_OVERLAPS_MAINTENANCE = 20122
  export const NON_POSITIVE_CONSULTATION_ID = 20123
  export const NO_CONSULTATION_FOUND = 20124
  export const CONSULTANT_IS_NOT_AVAILABLE_ON_CONSULTATION_ROOM = 20125
  export const USER_IS_NOT_AVAILABLE_ON_CONSULTATION_ROOM = 20126
  export const CONSULTATION_ROOM_HAS_NOT_OPENED_YET = 20127
  export const AUDIO_TEST_IS_NOT_DONE = 20128
  export const CONSULTATION_ROOM_HAS_ALREADY_CLOSED = 20129
  export const RATING_ID_IS_NOT_POSITIVE = 20130
  export const INVALID_RATING = 20131
  export const END_OF_CONSULTATION_DATE_TIME_HAS_NOT_PASSED_YET = 20132
  export const NO_USER_RATING_FOUND = 20133
  export const USER_ACCOUNT_HAS_ALREADY_BEEN_RATED = 20134
  export const ACCOUNT_IS_NOT_AVAILABLE = 20135
  export const NO_CONSULTANT_RATING_FOUND = 20136
  export const CONSULTANT_HAS_ALREADY_BEEN_RATED = 20137
}
...
codeToMessage.set(Code.CONSULTANT_IS_NOT_AVAILABLE_ON_CONSULTATION_ACCEPTANCE.toString(), `${Message.CONSULTANT_IS_NOT_AVAILABLE_ON_CONSULTATION_ACCEPTANCE_MESSAGE} (${Code.CONSULTANT_IS_NOT_AVAILABLE_ON_CONSULTATION_ACCEPTANCE})`)
codeToMessage.set(Code.USER_IS_NOT_AVAILABLE_ON_CONSULTATION_ACCEPTANCE.toString(), `${Message.USER_IS_NOT_AVAILABLE_ON_CONSULTATION_ACCEPTANCE_MESSAGE} (${Code.USER_IS_NOT_AVAILABLE_ON_CONSULTATION_ACCEPTANCE})`)
...
codeToMessage.set(Code.CONSULTANT_IS_NOT_AVAILABLE_ON_CONSULTATION_ROOM.toString(), `${Message.CONSULTANT_IS_NOT_AVAILABLE_ON_CONSULTATION_ROOM_MESSAGE} (${Code.CONSULTANT_IS_NOT_AVAILABLE_ON_CONSULTATION_ROOM})`)
codeToMessage.set(Code.USER_IS_NOT_AVAILABLE_ON_CONSULTATION_ROOM.toString(), `${Message.USER_IS_NOT_AVAILABLE_ON_CONSULTATION_ROOM_MESSAGE} (${Code.USER_IS_NOT_AVAILABLE_ON_CONSULTATION_ROOM})`)
...
codeToMessage.set(Code.ACCOUNT_IS_NOT_AVAILABLE.toString(), `${Message.ACCOUNT_IS_NOT_AVAILABLE_MESSAGE} (${Code.ACCOUNT_IS_NOT_AVAILABLE})`)
