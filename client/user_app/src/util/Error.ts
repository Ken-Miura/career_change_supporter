...
export namespace Code {
  ...
  export const USER_IS_NOT_AVAILABLE = 20135
...
codeToMessage.set(Code.USER_IS_NOT_AVAILABLE.toString(), `${Message.USER_IS_NOT_AVAILABLE_MESSAGE} (${Code.USER_IS_NOT_AVAILABLE})`)
