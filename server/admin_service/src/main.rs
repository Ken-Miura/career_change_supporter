...
use crate::handlers::session::authentication::authenticated_handlers::create_career_request::career_images::get_career_images;
use crate::handlers::session::authentication::authenticated_handlers::create_career_request::create_career_request_approval::post_create_career_request_approval;
use crate::handlers::session::authentication::authenticated_handlers::create_career_request::create_career_request_detail::get_create_career_request_detail;
use crate::handlers::session::authentication::authenticated_handlers::create_career_request::create_career_request_rejection::post_create_career_request_rejection;
use crate::handlers::session::authentication::authenticated_handlers::create_career_request::create_career_requests::get_create_career_requests;
...
use crate::handlers::session::authentication::authenticated_handlers::identity_request::create_identity_request::create_identity_request_approval::post_create_identity_request_approval;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::create_identity_request::create_identity_request_detail::get_create_identity_request_detail;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::create_identity_request::create_identity_request_rejection::post_create_identity_request_rejection;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::create_identity_request::create_identity_requests::get_create_identity_requests;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::create_identity_request::users_by_date_of_birth::get_users_by_date_of_birth;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::identity_images::get_identity_images;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::update_identity_request::update_identity_request_approval::post_update_identity_request_approval;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::update_identity_request::update_identity_request_detail::get_update_identity_request_detail;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::update_identity_request::update_identity_request_rejection::post_update_identity_request_rejection;
use crate::handlers::session::authentication::authenticated_handlers::identity_request::update_identity_request::update_identity_requests::get_update_identity_requests;
