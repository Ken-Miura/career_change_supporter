...
export function getMinDurationBeforeConsultationInDays (): number {
  return MIN_DURATION_BEFORE_CONSULTATION_IN_DAYS
}

export function getMaxDurationBeforeConsultationInDays (): number {
  return MAX_DURATION_BEFORE_CONSULTATION_IN_HOUR
}
