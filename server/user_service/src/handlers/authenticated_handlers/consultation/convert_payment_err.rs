...
pub(super) fn convert_payment_err_to_err_resp(e: &common::payment_platform::Error) -> ErrResp {
    match e {
...
mod tests {
    ...
    use crate::{
        err::Code,
        handlers::authenticated_handlers::consultation::convert_payment_err::convert_payment_err_to_err_resp,
    };
