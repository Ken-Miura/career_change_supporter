...
export namespace Message {
    ...
    export const SKY_WAY_FAILED_TO_CREATE_ROOM_MESSAGE = `${SKY_WAY_UNEXPECTED_ERROR_MESSAGE}: SKY_WAY_FAILED_TO_CREATE_ROOM`
    export const SKY_WAY_NO_ROOM_FOUND_MESSAGE = `${SKY_WAY_UNEXPECTED_ERROR_MESSAGE}: SKY_WAY_NO_ROOM_FOUND`
    export const SKY_WAY_FAILED_TO_CREATE_MEMBER_MESSAGE = `${SKY_WAY_UNEXPECTED_ERROR_MESSAGE}: SKY_WAY_FAILED_TO_CREATE_MEMBER`
