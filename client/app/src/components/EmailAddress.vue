<template>
  <div class="mb-6 pt-3 rounded bg-gray-200">
    ...
    <input @input="onInput" type="email" required minlength="1" maxlength="254" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-gray-600 transition duration-500 px-3 pb-3">
  </div>
</template>
